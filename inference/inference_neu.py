...
llm = Llama(
    model_path="models/model_v10.Q4_K_M.gguf",
    n_ctx=15000,
    verbose=False
)

with open("data/testdaten3_v2.json", "r", encoding="utf-8") as file:
    data = json.load(file)
    for i, dataset in enumerate(data):
        ...
        with open("tests/neu/test_result_v10.txt", "a", encoding="utf-8") as datei:
