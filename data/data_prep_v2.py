...
with open("data/daten.csv", "r", encoding="utf-8") as file:
    ...
    for i, row in enumerate(csv_reader):
        ...
        # Formatieren des Transkripts in Alpaca Format
        data = {
            "instruction": "Bitte schlage passende Schnitte vor basierend auf dem Transkript und der Beschreibung.",
            "input": f"Beschreibung: {beschreibung}\nTranskript: {format_transkript(transkript)}",
            "output": format_schnitte(schnitte)
        }
        if i < 20:
